  ...
  METHOD msg_get.
    ...
    CASE lv_kind.
      ...
      WHEN cl_abap_datadescr=>typekind_struct1 OR cl_abap_datadescr=>typekind_struct2.
        ...
        DATA(lt_attri) = zabap2ui5_cl_util=>rtti_get_t_attri_by_any( val ).

        DATA(ls_result) = VALUE zabap2ui5_cl_util=>ty_s_msg( ).
      ...
      WHEN cl_abap_datadescr=>typekind_oref.
        TRY.
            ...
            DATA(lt_attri_o) = zabap2ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
              ...
              CATCH cx_root.
                ...
                TRY.
                  ...
                  CATCH cx_root INTO DATA(lx2).
                    ...
                    lt_attri_o = zabap2ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
      ...
      WHEN OTHERS.
        ...
        IF zabap2ui5_cl_util=>rtti_check_clike( val ).
