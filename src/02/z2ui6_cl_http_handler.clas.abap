CLASS z2ui6_cl_http_handler DEFINITION
  ...
  PROTECTED SECTION.
    ...
    CLASS-DATA so_sticky_handler TYPE REF TO z2ui6_cl_core_http_post.
    DATA mo_server TYPE REF TO z2ui6_cl_abap_api_http.
    DATA ms_session_attributes TYPE z2ui6_if_types=>ty_s_http_handler_attributes.
    ...
    TYPES:
      BEGIN OF ty_s_http_res,
        ...
        t_header      TYPE z2ui6_if_types=>ty_t_name_value,
    ...
    METHODS set_config
      IMPORTING
        is_custom_config TYPE z2ui6_if_types=>ty_s_http_config.
    ...
    METHODS session_handling
      IMPORTING
        attributes TYPE z2ui6_if_types=>ty_s_http_handler_attributes.
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
  ...
  METHOD http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW z2ui6_cl_core_http_post( ms_req-body ).
    ELSE.
