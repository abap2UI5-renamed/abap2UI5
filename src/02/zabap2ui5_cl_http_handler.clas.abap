CLASS zabap2ui5_cl_http_handler DEFINITION
  ...
  PROTECTED SECTION.
    ...
    DATA mo_server TYPE REF TO zabap2ui5_cl_abap_api_http.
...
CLASS zabap2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = zabap2ui5_cl_abap_api_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = zabap2ui5_cl_abap_api_http=>factory_cloud( req = req
                                                               res = res ).
