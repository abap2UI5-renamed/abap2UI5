CLASS z5ui5_cl_xml_view DEFINITION
  ...
  PUBLIC SECTION.
    CLASS-METHODS factory
      IMPORTING t_ns          TYPE z5ui5_if_types=>ty_t_name_value OPTIONAL
    ...
    METHODS _generic_property
      IMPORTING val           TYPE z5ui5_if_types=>ty_s_name_value OPTIONAL
      RETURNING VALUE(result) TYPE REF TO z5ui5_cl_xml_view.
    ...
    METHODS _z2ui5
      RETURNING VALUE(result) TYPE REF TO z5ui5_cl_xml_view_cc.
...
CLASS z5ui5_cl_xml_view IMPLEMENTATION.
  ...
  METHOD filter_bar.
    ...
    result = _generic(
        ...
        ns     = 'fb'
        t_prop = VALUE #(
            ( n = 'useToolbar'     v = z5ui5_cl_util=>boolean_abap_2_json( usetoolbar ) )
            ( n = 'search'         v = search )
            ( n = 'id'             v = id )
            ...
            ( n = 'disableSearchMatchesPatternWarning'
              v = z5ui5_cl_util=>boolean_abap_2_json( disablesearchmatchespatternw ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `enableCollapseButtonWhenEmpty`
                       v = z5ui5_cl_util=>boolean_abap_2_json( enablecollapsebuttonwhenempty ) )
                     ( n = `navigated`           v = z5ui5_cl_util=>boolean_abap_2_json( navigated ) )
                     ( n = `selected`           v = z5ui5_cl_util=>boolean_abap_2_json( selected ) )
  ...
  METHOD object_page_header.
    ...
    _generic(
        ...
        ns     = `uxap`
        t_prop = VALUE #(
            ( n = `isActionAreaAlwaysVisible`  v = z5ui5_cl_util=>boolean_abap_2_json( isactionareaalwaysvisible ) )
            ( n = `isObjectIconAlwaysVisible`       v = z5ui5_cl_util=>boolean_abap_2_json( isobjecticonalwaysvisible ) )
            ( n = `isObjectSubtitleAlwaysVisible`
              v = z5ui5_cl_util=>boolean_abap_2_json( isobjectsubtitlealwaysvisible ) )
...
*              ns     = `webc`
    ...
    result = _generic( name   = `Status`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `useFocusColorAsContentColor`
                             v = z5ui5_cl_util=>boolean_abap_2_json( useFocusColorAsContentColor ) )
                           ( n = `visible`           v = z5ui5_cl_util=>boolean_abap_2_json( visible ) ) ) ).
  ...
  METHOD variant_item.
    ...
    result = _generic(
                 ...
                 ns     = `vm`
                 t_prop = VALUE #(
                     ( n = `executeOnSelection`      v = z5ui5_cl_util=>boolean_abap_2_json( executeonselection ) )
    ...
    result = _generic(
                 ...
                 t_prop = VALUE #(
                     ...
                     ( n = `executeOnSelectionForStandardDefault`
                       v = z5ui5_cl_util=>boolean_abap_2_json( executeonselectionforstandflt ) )
                     ( n = `headerLevel`      v = headerlevel )
                     ( n = `inErrorState`      v = z5ui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                     ( n = `maxWidth`      v = maxwidth )
