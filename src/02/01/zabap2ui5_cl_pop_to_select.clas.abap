CLASS zabap2ui5_cl_pop_to_select DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)    TYPE REF TO zabap2ui5_cl_pop_to_select.
...
CLASS zabap2ui5_cl_pop_to_select IMPLEMENTATION.
  ...
  METHOD display.
    ...
    DATA(tab) = popup->table_select_dialog(
        items            = |\{path:'|
                          ...
                          && zabap2ui5_cl_util=>boolean_abap_2_json( me->descending )
                          && | \} \}|
    ...
    DATA(lt_comp) = zabap2ui5_cl_util=>rtti_get_t_attri_by_any( <tab_out> ).
    ...
    LOOP AT lt_comp INTO ls_comp.
      DATA(text) = COND #(
                     LET data_element_name = substring_after(
                                                 ...
                                                 sub = '\TYPE=' )
                         medium_label = zabap2ui5_cl_util=>rtti_get_data_element_texts( data_element_name )-medium IN
