CLASS /2u5/test_cl_pop_itab_json_dl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO /2u5/test_cl_pop_itab_json_dl.
...
CLASS /2u5/test_cl_pop_itab_json_dl IMPLEMENTATION.


  METHOD factory.

    r_result = NEW #( ).
    r_result->mr_itab = /2u5/test_cl_util=>conv_copy_ref_data( itab ).
  ...
  METHOD /2u5/test_if_app~main.
    ...
    TRY.
        ...
        IF /2u5/test_cl_util=>rtti_check_class_exists( `z2ui5_dbt_cl_app_03` ) = abap_false.
          ...
          DATA(lx) = NEW /2u5/test_cx_util_error( val = lv_text ).
          client->nav_app_leave( /2u5/test_cl_pop_error=>factory( lx ) ).
      ...
      CATCH cx_root INTO DATA(x).
        client->nav_app_leave( /2u5/test_cl_pop_to_inform=>factory( x->get_text( ) ) ).
    ENDTRY.
  ENDMETHOD.
ENDCLASS.
