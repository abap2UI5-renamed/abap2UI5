CLASS /2ui5/test_cl_pop_get_range_m DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      IMPORTING
        val             TYPE /2ui5/test_cl_util=>ty_t_filter_multi
      RETURNING
        VALUE(r_result) TYPE REF TO /2ui5/test_cl_pop_get_range_m.

    TYPES:
      BEGIN OF ty_s_result,
        t_sql           TYPE /2ui5/test_cl_util=>ty_t_filter_multi,
...
CLASS /2ui5/test_cl_pop_get_range_m IMPLEMENTATION.
  ...
  METHOD popup_display.
    ...
    DATA(lo_popup) = /2ui5/test_cl_xml_view=>factory_popup( ).
  ...
  METHOD /2ui5/test_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      DATA(lo_popup) = CAST /2ui5/test_cl_pop_get_range( client->get_app( client->get( )-s_draft-id_prev_app ) ).
      IF lo_popup->result( )-check_confirmed = abap_true.
        ...
        <tab>-t_token = /2ui5/test_cl_util=>filter_get_token_t_by_range_t( <tab>-t_range ).
      ENDIF.
      popup_display( ).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'LIST_OPEN'.
        ...
        client->nav_app_call( /2ui5/test_cl_pop_get_range=>factory( ls_sql-t_range ) ).
