CLASS z2ui6_cl_app_startup DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO z2ui6_cl_app_startup.
...
CLASS z2ui6_cl_app_startup IMPLEMENTATION.
  ...
  METHOD on_event_check.
    ...
    TRY.
        ...
        ms_home-url               = z2ui6_cl_core_srv_util=>app_get_url( client    = client
  ...
  METHOD view_display_start.
    ...
    DATA(lv_url_samples2) = z2ui6_cl_core_srv_util=>app_get_url( client    = client
  ...
  METHOD view_display_popup.
    ...
    simple_form2->checkbox( enabled  = abap_false
                            selected = z2ui6_cl_util=>context_check_abap_cloud( ) ).
...
*        client->nav_app_call( z2ui5_cl_core_app_info=>factory( ) ).
  ...
  METHOD z2ui5_on_init.
    ...
    ms_home-class_editable = abap_true.
    ms_home-btn_icon       = `sap-icon://validate`.
    ms_home-classname      = z2ui6_cl_util=>rtti_get_classname_by_ref( NEW z2ui6_cl_app_hello_world( ) ).
