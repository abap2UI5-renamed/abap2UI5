CLASS /2ui5/test_cl_core_http_post DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE /2ui5/test_if_core_types=>ty_s_http_request_post.
    DATA ms_response     TYPE /2ui5/test_if_core_types=>ty_s_http_response_post.
...
CLASS /2ui5/test_cl_core_http_post IMPLEMENTATION.


  METHOD constructor.

    mv_request_json = val.
    mo_action = NEW /2ui5/test_cl_core_action( me ).
  ...
  METHOD main_end.
    ...
    ms_response = VALUE #(
        ...
        s_front-app    = /2ui5/test_cl_util=>rtti_get_classname_by_ref( mo_action->mo_app->mo_app )
        ).
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW /2ui5/test_cl_core_client( mo_action ).
        DATA(li_app)    = CAST /2ui5/test_if_app( mo_action->mo_app->mo_app ).
