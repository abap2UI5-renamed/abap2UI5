CLASS z2ui6_cl_core_handler DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE z2ui6_if_core_types=>ty_s_request.
    DATA ms_response     TYPE z2ui6_if_core_types=>ty_s_response.
...
CLASS z2ui6_cl_core_handler IMPLEMENTATION.
  ...
  METHOD main_begin.
    TRY.
        ...
        ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
          NEW z2ui6_cl_core_srv_draft( )->cleanup( ).
  ...
  METHOD main_end.
    ...
    IF    ms_response-s_front-params-s_view-check_update_model        = abap_true
      ...
      DATA(lo_model) = NEW z2ui6_cl_core_srv_attri( attri = mo_action->mo_app->mt_attri
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW z2ui6_cl_core_client( mo_action ).
