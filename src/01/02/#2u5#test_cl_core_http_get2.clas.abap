CLASS /2u5/test_cl_core_http_get2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        val TYPE /2u5/test_if_types=>ty_s_config_index_html OPTIONAL.
  ...
  PROTECTED SECTION.
    ...
    CLASS-DATA cs_config_default TYPE /2u5/test_if_types=>ty_s_config_index_html.

    DATA ms_config_in      TYPE /2u5/test_if_types=>ty_s_config_index_html.
    ...
    METHODS main_set_config
      RETURNING
        VALUE(result) TYPE /2u5/test_if_types=>ty_s_config_index_html.

    METHODS main_set_index_html
      IMPORTING
        cs_config TYPE /2u5/test_if_types=>ty_s_config_index_html.
...
CLASS /2u5/test_cl_core_http_get2 IMPLEMENTATION.
...
*         (  n = `src`                       v = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js` )
  ...
  METHOD main_set_index_html.
    ...
    mv_index_html = mv_index_html  &&
     ...
     |         {  get_js( ) }     \n| &&
     |         { lv_add_js  }     \n| &&
     |         { /2u5/test_cl_cc_debug_tool=>get_js( )  }     \n| &&
  ...
  METHOD get_js.
    ...
    DATA(lv_two_way_model) = /2u5/test_if_core_types=>cs_ui5-two_way_model.
