CLASS /2u5/test_cl_core_ui5_app DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS index_html
      IMPORTING
        is_config     TYPE /2u5/test_if_types=>ty_s_http_config
      RETURNING
        VALUE(result) TYPE string.

ENDCLASS.

CLASS /2u5/test_cl_core_ui5_app IMPLEMENTATION.

  METHOD index_html.

    IF is_config-styles_css IS INITIAL.
      DATA(lv_style_css) = NEW /2u5/test_cl_core_ui5_app( )->css_style_css( ).
    ELSE.
    ...
    result = `<!DOCTYPE html>` && |\n| &&
             ...
             `      "z2ui5/manifest.json": '` && NEW /2u5/test_cl_core_ui5_app( )->manifest_json( ) && ` ',` && |\n| &&
             `      "z2ui5/Component.js": function(){` && NEW /2u5/test_cl_core_ui5_app( )->component_js( ) && is_config-custom_js && ` },` && |\n| &&
             `      "z2ui5/css/style.css": '` && lv_style_css && `',` && |\n| &&
             `      "z2ui5/model/models.js": function(){` && NEW /2u5/test_cl_core_ui5_app( )->model_models_js( ) && `},` && |\n| &&
             `      "z2ui5/i18n/i18n.properties": '` && NEW /2u5/test_cl_core_ui5_app( )->i18n_i18n_properties( ) && `' ,` && |\n| &&
             `      "z2ui5/view/App.view.xml": '` && NEW /2u5/test_cl_core_ui5_app( )->view_app_xml( )  && `' ,` && |\n| &&
             `      "z2ui5/controller/App.controller.js": function(){` && NEW /2u5/test_cl_core_ui5_app( )->controller_app_js( ) && `},` && |\n| &&
             `      "z2ui5/view/View1.view.xml": '` && NEW /2u5/test_cl_core_ui5_app( )->view_view1_xml( )  && `' ,` && |\n| &&
             `      "z2ui5/controller/View1.controller.js": function(){` && NEW /2u5/test_cl_core_ui5_app( )->controller_view1_js( ) && `},` && |\n| &&
             `      "z2ui5/cc/DebugTool.fragment.xml": '` && /2u5/test_cl_cc_debug_tool=>get_xml( )  && `' ,` && |\n| &&
             `      "z2ui5/cc/DebugTool.js": function(){` && /2u5/test_cl_cc_debug_tool=>get_js( ) && `},` && |\n| &&
             `    });` && |\n| &&
