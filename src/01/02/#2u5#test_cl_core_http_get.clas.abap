CLASS /2u5/test_cl_core_http_get DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request TYPE /2u5/test_if_types=>ty_s_http_request_get.
...
*        cs_config     TYPE z2ui5_if_types=>ty_s_http_request_get
  ...
  PROTECTED SECTION.
    ...
    METHODS get_default_config
      RETURNING
        VALUE(result) TYPE /2u5/test_if_types=>ty_s_http_request_get.
    ...
    METHODS main_get_index_html
      IMPORTING
                cs_config     TYPE /2u5/test_if_types=>ty_s_http_request_get
...
CLASS /2u5/test_cl_core_http_get IMPLEMENTATION.
