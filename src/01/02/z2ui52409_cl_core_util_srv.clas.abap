CLASS z2ui52409_cl_core_util_srv DEFINITION
  PUBLIC
  INHERITING FROM z2ui52409_cl_util
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS app_get_url_source_code
      IMPORTING
        !client       TYPE REF TO z2ui52409_if_client
      RETURNING
...
CLASS z2ui52409_cl_core_util_srv IMPLEMENTATION.
