CLASS /2ui5/test_cl_core_http_get DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request TYPE /2ui5/test_if_types=>ty_s_http_request_get.
    DATA mv_response TYPE string.

    METHODS constructor
      IMPORTING
        val TYPE /2ui5/test_if_types=>ty_s_http_request_get OPTIONAL.
  ...
  PROTECTED SECTION.
    ...
    METHODS get_default_config
      RETURNING
        VALUE(result) TYPE /2ui5/test_if_types=>ty_s_http_request_get-t_config.
...
CLASS /2ui5/test_cl_core_http_get IMPLEMENTATION.
...
*        (  n = `src`                       v = `https://ui5.sap.com/1.124.0/resources/sap-ui-core.js` )
  ...
  METHOD get_js.
    ...
    DATA(lv_two_way_model) = /2ui5/test_if_core_types=>cs_ui5-two_way_model.
...
`he App" }).open();  } } ) }` && |\n| &&
  ...
  METHOD get_js_cc_startup.
    ...
    result = ` ` &&
        /2ui5/test_cl_cc_timer=>get_js( ) &&
        /2ui5/test_cl_cc_focus=>get_js( ) &&
        /2ui5/test_cl_cc_title=>get_js( ) &&
        /2ui5/test_cl_cc_lp_title=>get_js( ) &&
        /2ui5/test_cl_cc_history=>get_js( ) &&
        /2ui5/test_cl_cc_scrolling=>get_js( ) &&
        /2ui5/test_cl_cc_info=>get_js( ) &&
        /2ui5/test_cl_cc_geoloc=>get_js( ) &&
        /2ui5/test_cl_cc_file_upl=>get_js( ) &&
        /2ui5/test_cl_cc_multiinput=>get_js( ) &&
        /2ui5/test_cl_cc_uitable=>get_js( ) &&
        /2ui5/test_cl_cc_util=>get_js( ) &&
        /2ui5/test_cl_cc_favicon=>get_js( ) &&
        /2ui5/test_cl_cc_dirty=>get_js( ) &&
       `  `.
  ...
  METHOD main.
    ...
    mv_response = mv_response &&
       /2ui5/test_cl_cc_debug_tool=>get_js( ).

    mv_response = mv_response && |\n| &&
                 `</script>` && |\n| &&
                 `<abc/></body></html>`.

    NEW /2ui5/test_cl_core_draft_srv( )->cleanup( ).
    result = mv_response.
