INTERFACE z2ui6_if_core_types
  ...
  TYPES:
    BEGIN OF ty_s_bind_config,
      ...
      view               TYPE string,
      custom_mapper      TYPE REF TO z2ui6_if_ajson_mapping,
      custom_mapper_back TYPE REF TO z2ui6_if_ajson_mapping,
      custom_filter      TYPE REF TO z2ui6_if_ajson_filter,
  ...
  TYPES:
    BEGIN OF ty_s_attri,
      ...
      view               TYPE string,
      json_bind_local    TYPE REF TO z2ui6_if_ajson,
      custom_filter      TYPE REF TO z2ui6_if_ajson_filter,
      custom_filter_back TYPE REF TO z2ui6_if_ajson_filter,
      custom_mapper      TYPE REF TO z2ui6_if_ajson_mapping,
      custom_mapper_back TYPE REF TO z2ui6_if_ajson_mapping,
  ...
  TYPES:
    BEGIN OF ty_s_next_frontend,
      ...
      handler_attrs TYPE z2ui6_if_types=>ty_s_http_handler_attributes,
  ...
  TYPES:
    BEGIN OF ty_s_http_request_post,
      ...
      BEGIN OF s_front,
        ...
        event       TYPE string,
        o_comp_data TYPE REF TO z2ui6_if_ajson,
        origin      TYPE string,
  ...
  TYPES:
    BEGIN OF ty_s_config,
      ...
      pathname         TYPE string,
      search           TYPE string,
      t_startup_params TYPE z2ui6_if_types=>ty_t_name_value,
    END OF ty_s_config.
