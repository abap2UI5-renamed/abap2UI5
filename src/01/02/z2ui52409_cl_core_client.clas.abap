CLASS z2ui52409_cl_core_client DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.

    INTERFACES z2ui52409_if_client .

    DATA mo_action TYPE REF TO z2ui52409_cl_core_action.

    METHODS constructor
      IMPORTING
        !action TYPE REF TO z2ui52409_cl_core_action.
...
CLASS z2ui52409_cl_core_client IMPLEMENTATION.
  ...
  METHOD z2ui52409_if_client~follow_up_action.
  ...
  METHOD z2ui52409_if_client~get.
  ...
  METHOD z2ui52409_if_client~get_event_arg.
  ...
  METHOD z2ui52409_if_client~get_app.

    IF id IS NOT INITIAL.
      DATA(lo_app) = z2ui52409_cl_core_app=>db_load( id ).
  ...
  METHOD z2ui52409_if_client~message_box_display.
  ...
  METHOD z2ui52409_if_client~message_toast_display.
  ...
  METHOD z2ui52409_if_client~nav_app_call.

    IF app IS NOT BOUND.
      z2ui52409_cl_util=>x_raise( `NAV_APP_LEAVE_TO_INITIAL_APP_ERROR` ).
    ENDIF.

    mo_action->ms_next-o_app_call = app.

    IF app->id_app IS INITIAL.
      app->id_app = z2ui52409_cl_util=>uuid_get_c32( ).
    ENDIF.
    result = app->id_app.
  ENDMETHOD.


  METHOD z2ui52409_if_client~nav_app_leave.

    IF app IS NOT SUPPLIED.
      app = z2ui52409_if_client~get_app( z2ui52409_if_client~get( )-s_draft-id_prev_app_stack ).
    ENDIF.
  ...
  METHOD z2ui52409_if_client~nest2_view_destroy.
  ...
  METHOD z2ui52409_if_client~nest2_view_display.
  ...
  METHOD z2ui52409_if_client~nest2_view_model_update.
  ...
  METHOD z2ui52409_if_client~nest_view_destroy.
  ...
  METHOD z2ui52409_if_client~nest_view_display.
  ...
  METHOD z2ui52409_if_client~nest_view_model_update.
  ...
  METHOD z2ui52409_if_client~popover_destroy.
  ...
  METHOD z2ui52409_if_client~popover_display.
  ...
  METHOD z2ui52409_if_client~popover_model_update.
  ...
  METHOD z2ui52409_if_client~popup_destroy.
  ...
  METHOD z2ui52409_if_client~popup_display.
  ...
  METHOD z2ui52409_if_client~popup_model_update.
  ...
  METHOD z2ui52409_if_client~view_destroy.
  ...
  METHOD z2ui52409_if_client~view_display.
  ...
  METHOD z2ui52409_if_client~view_model_update.
  ...
  METHOD z2ui52409_if_client~_bind.

    DATA(lo_bind) = NEW z2ui52409_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = z2ui52409_cl_util=>conv_get_as_data_ref( val )
      type   = z2ui52409_if_core_types=>cs_bind_type-one_way
      config = VALUE #(
         path_only     = path
         custom_filter = custom_filter
         custom_mapper = custom_mapper
         tab           = z2ui52409_cl_util=>conv_get_as_data_ref( tab )
         tab_index     = tab_index ) ).

  ENDMETHOD.


  METHOD z2ui52409_if_client~_bind_edit.

    DATA(lo_bind) = NEW z2ui52409_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = z2ui52409_cl_util=>conv_get_as_data_ref( val )
      type   = z2ui52409_if_core_types=>cs_bind_type-two_way
      config = VALUE #(
         path_only          = path
         custom_filter      = custom_filter
  ...
  METHOD z2ui52409_if_client~_bind_local.
  ...
  METHOD z2ui52409_if_client~_event.

    DATA(lo_ui5) = NEW z2ui52409_cl_core_event_srv( ).
  ...
  METHOD z2ui52409_if_client~_event_client.
  ...
  METHOD z2ui52409_if_client~set_session_stateful.

    DATA(lv_check_sticky) =  CAST z2ui52409_if_app( mo_action->mo_app->mo_app )->check_sticky.
    ...
    IF stateful = abap_true.
      ...
      CAST z2ui52409_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_true.
    ELSE.
      mo_action->ms_next-s_set-handler_attrs-stateful-active = 0.
      CAST z2ui52409_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
    ENDIF.
