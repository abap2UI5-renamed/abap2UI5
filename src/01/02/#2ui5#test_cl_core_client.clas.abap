CLASS /2ui5/test_cl_core_client DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES /2ui5/test_if_client .

    DATA mo_action TYPE REF TO /2ui5/test_cl_core_action.

    METHODS constructor
      IMPORTING
        !action TYPE REF TO /2ui5/test_cl_core_action.
...
CLASS /2ui5/test_cl_core_client IMPLEMENTATION.
  ...
  METHOD /2ui5/test_if_client~follow_up_action.
  ...
  METHOD /2ui5/test_if_client~get.
  ...
  METHOD /2ui5/test_if_client~get_app.

    IF id IS NOT INITIAL.
      DATA(lo_app) = /2ui5/test_cl_core_app=>db_load( id ).
  ...
  METHOD /2ui5/test_if_client~message_box_display.
  ...
  METHOD /2ui5/test_if_client~message_toast_display.
  ...
  METHOD /2ui5/test_if_client~nav_app_call.

    IF app IS NOT BOUND.
      /2ui5/test_cl_util=>x_raise( `NAV_APP_LEAVE_TO_INITIAL_APP_ERROR` ).
    ENDIF.

    mo_action->ms_next-o_app_call = app.

    IF app->id_app IS INITIAL.
      app->id_app = /2ui5/test_cl_util=>uuid_get_c32( ).
    ENDIF.
    result = app->id_app.
  ENDMETHOD.


  METHOD /2ui5/test_if_client~nav_app_leave.

    IF app IS NOT SUPPLIED.
      app = /2ui5/test_if_client~get_app( /2ui5/test_if_client~get( )-s_draft-id_prev_app_stack ).
    ENDIF.
  ...
  METHOD /2ui5/test_if_client~nest2_view_destroy.
  ...
  METHOD /2ui5/test_if_client~nest2_view_display.
  ...
  METHOD /2ui5/test_if_client~nest2_view_model_update.
  ...
  METHOD /2ui5/test_if_client~nest_view_destroy.
  ...
  METHOD /2ui5/test_if_client~nest_view_display.
  ...
  METHOD /2ui5/test_if_client~nest_view_model_update.
  ...
  METHOD /2ui5/test_if_client~popover_destroy.
  ...
  METHOD /2ui5/test_if_client~popover_display.
  ...
  METHOD /2ui5/test_if_client~popover_model_update.
  ...
  METHOD /2ui5/test_if_client~popup_destroy.
  ...
  METHOD /2ui5/test_if_client~popup_display.
  ...
  METHOD /2ui5/test_if_client~popup_model_update.
  ...
  METHOD /2ui5/test_if_client~view_destroy.
  ...
  METHOD /2ui5/test_if_client~view_display.
  ...
  METHOD /2ui5/test_if_client~view_model_update.
  ...
  METHOD /2ui5/test_if_client~_bind.

    DATA(lo_bind) = NEW /2ui5/test_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = /2ui5/test_cl_util=>conv_get_as_data_ref( val )
      type   = /2ui5/test_if_core_types=>cs_bind_type-one_way
      config = VALUE #(
         path_only     = path
         custom_filter = custom_filter
         custom_mapper = custom_mapper
         tab           = /2ui5/test_cl_util=>conv_get_as_data_ref( tab )
         tab_index     = tab_index ) ).

  ENDMETHOD.


  METHOD /2ui5/test_if_client~_bind_edit.

    DATA(lo_bind) = NEW /2ui5/test_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = /2ui5/test_cl_util=>conv_get_as_data_ref( val )
      type   = /2ui5/test_if_core_types=>cs_bind_type-two_way
      config = VALUE #(
         path_only          = path
         custom_filter      = custom_filter
  ...
  METHOD /2ui5/test_if_client~_bind_local.
  ...
  METHOD /2ui5/test_if_client~_event.

    DATA(lo_ui5) = NEW /2ui5/test_cl_core_event_srv( ).
  ...
  METHOD /2ui5/test_if_client~_event_client.
