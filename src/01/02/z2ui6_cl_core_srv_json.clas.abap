CLASS z2ui6_cl_core_srv_json DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE z2ui6_if_core_types=>ty_s_request .

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE z2ui6_if_core_types=>ty_s_response
      RETURNING
...
*              ASSERT sy-subrc = 0.
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result = ajson_result->filter( NEW z2ui6_cl_core_srv_json( ) ).
