...
*               `        sap.z2ui5.oDeviceModel.setDefaultBindingMode("OneWay");` && |\n|  &&
  ...
  METHOD get_js_cc_startup.
    ...
    result = ` ` &&
        z5ui5_cl_cc_timer=>get_js( ) &&
        z5ui5_cl_cc_focus=>get_js( ) &&
        z5ui5_cl_cc_title=>get_js( ) &&
        z5ui5_cl_cc_history=>get_js( ) &&
        z5ui5_cl_cc_scrolling=>get_js( ) &&
        z5ui5_cl_cc_info=>get_js( ) &&
        z5ui5_cl_cc_geoloc=>get_js( ) &&
        z5ui5_cl_cc_file_upl=>get_js( ) &&
        z5ui5_cl_cc_multiinput=>get_js( ) &&
        z5ui5_cl_cc_uitable=>get_js( ) &&
        z5ui5_cl_cc_util=>get_js( ) &&
        z5ui5_cl_cc_favicon=>get_js( ) &&
       `  `.
