...
CLASS z2ui52409_cl_core_diss_srv DEFINITION LOCAL FRIENDS ltcl_test_dissolve.
...
CLASS ltcl_test_dissolve IMPLEMENTATION.
  ...
  METHOD test_ref.
    ...
    DATA lt_attri TYPE z2ui52409_if_core_types=>ty_t_attri.
    DATA(lo_model) = NEW z2ui52409_cl_core_diss_srv(
      attri = REF #( lt_attri )
      app   = lo_app ).
