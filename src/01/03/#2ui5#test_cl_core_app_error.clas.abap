CLASS /2ui5/test_cl_core_app_error DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO /2ui5/test_cl_core_app_error.
...
CLASS /2ui5/test_cl_core_app_error IMPLEMENTATION.
  ...
  METHOD /2ui5/test_if_app~main.
    ...
    DATA(view) = /2ui5/test_cl_xml_view=>factory( ).
