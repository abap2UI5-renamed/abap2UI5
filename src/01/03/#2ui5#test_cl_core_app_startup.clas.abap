CLASS /2ui5/test_cl_core_app_startup DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO /2ui5/test_cl_core_app_startup.
  ...
  PROTECTED SECTION.
    DATA mt_classes TYPE /2ui5/test_cl_util=>ty_t_classes.
...
CLASS /2ui5/test_cl_core_app_startup IMPLEMENTATION.
  ...
  METHOD on_event_check.
    DATA li_app_test TYPE REF TO /2ui5/test_if_app.

    TRY.
        ms_home-classname = /2ui5/test_cl_util=>c_trim_upper( ms_home-classname ).
        ...
        ms_home-url = /2ui5/test_cl_core_util_srv=>app_get_url(
                   client    = client
  ...
  METHOD view_display_start.
    ...
    DATA(page2) = /2ui5/test_cl_xml_view=>factory( )->shell( )->page(
    ...
    DATA(lv_url_samples2) = /2ui5/test_cl_core_util_srv=>app_get_url(
                  client    = client
                  classname = 'z2ui5_cl_demo_app_000' ).

    simple_form2->toolbar( )->title( `What's next?` ).

    IF /2ui5/test_cl_util=>rtti_check_class_exists( `z2ui5_cl_demo_app_000` ).
  ...
  METHOD /2ui5/test_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      TRY.
          DATA(lo_f4) = CAST /2ui5/test_cl_pop_to_select( client->get_app( client->get( )-s_draft-id_prev_app ) ).
  ...
  METHOD z2ui5_on_event.
    ...
    DATA li_app TYPE REF TO /2ui5/test_if_app.
    ...
    CASE client->get( )-event.
      ...
      WHEN `OPEN_INFO`.
        client->nav_app_call( /2ui5/test_cl_core_app_info=>factory( ) ).
        RETURN.
      ...
      WHEN 'VALUE_HELP'.
        TRY.
            mt_classes = /2ui5/test_cl_util=>rtti_get_classes_impl_intf( /2ui5/test_cl_util=>rtti_get_intfname_by_ref( li_app ) ).
          CATCH cx_root.
            client->message_box_display( `Unfortunately the value help is not available on your ABAP release!` ).
            RETURN.
        ENDTRY.
        client->nav_app_call( /2ui5/test_cl_pop_to_select=>factory( mt_classes ) ).
    ENDCASE.
  ...
  METHOD z2ui5_on_init.
    ...
    ms_home-class_editable = abap_true.
    ms_home-btn_icon       = `sap-icon://validate`.
    ms_home-classname      = /2ui5/test_cl_util=>rtti_get_classname_by_ref( NEW /2ui5/test_cl_core_app_hello_w( ) ).
