CLASS /2u5/test_cl_core_util_srv DEFINITION
  PUBLIC
  INHERITING FROM /2u5/test_cl_util
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS app_get_url_source_code
      IMPORTING
        !client       TYPE REF TO /2u5/test_if_client
      RETURNING
...
CLASS /2u5/test_cl_core_util_srv IMPLEMENTATION.
