...
CLASS /2u5/test_cl_core_diss_srv DEFINITION LOCAL FRIENDS ltcl_test_dissolve.
...
CLASS ltcl_test_dissolve IMPLEMENTATION.
  ...
  METHOD test_ref.
    ...
    DATA lt_attri TYPE /2u5/test_if_core_types=>ty_t_attri.
    DATA(lo_model) = NEW /2u5/test_cl_core_diss_srv(
      attri = REF #( lt_attri )
      app   = lo_app ).
