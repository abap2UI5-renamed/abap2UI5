CLASS zabap2ui5_cl_core_srv_draft DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS create
      IMPORTING
        draft     TYPE zabap2ui5_if_types=>ty_s_draft
    ...
    METHODS read_draft
      IMPORTING
        !id           TYPE clike
      RETURNING
        VALUE(result) TYPE zabap2ui5_if_core_types=>ty_s_db.
...
CLASS zabap2ui5_cl_core_srv_draft IMPLEMENTATION.
  METHOD cleanup.
    ...
    DELETE FROM zabap2ui5_t_01 WHERE timestampl < @lv_four_hours_ago.
    COMMIT WORK.
  ...
  METHOD create.
    ...
    DATA(ls_db) = VALUE zabap2ui5_if_core_types=>ty_s_db( id                = draft-id
  ...
  METHOD read.
    ...
    IF check_load_app = abap_true.
      ...
      SELECT SINGLE * FROM zabap2ui5_t_01
        WHERE id = @id
